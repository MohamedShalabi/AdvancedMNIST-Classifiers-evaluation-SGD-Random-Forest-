...
# # step11: plotting the curve  lets draw the recall precision curve to decide on our threshold
...
# note1:SGD Classifier is good for big data and binary classifier 
...
'''make a plot  function for groups of photos'''
def digits_plt(instances ,number_perraw = 10,**options):
    ...
    plt.axis("off")
some pla arround for comparing between  true predicted and false predicted valaues for digits 3 and 5 
classA ,classB = 3,5
